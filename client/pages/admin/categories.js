			...
			<div className='max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 min-h-screen flex justify-center'>
				<div className='h-96 px-10 mt-20 shadow-even rounded-xl flex flex-col justify-between'>
					<div className='flex flex-col justify-start'>
						<input
							className='border-2 border-black border-md rounded-md p-2 mt-6 mb-4'
						...
						<div className='flex flex-col items-center'>
							{categories.map((category) => (
								<div
									...
									key={category._id}>
									<h1 className='w-4/6 text-md font-bold'>
										{category.name}
									</h1>
					...
					<button
						className='h-12 bg-gray-900 text-white rounded-lg mb-6'
